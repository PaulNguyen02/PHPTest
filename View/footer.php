...
<div class="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-light mb-4">Được ủy quyền bởi</h4>
                    <img src="img/xado.jpg" width="120" height="60">
                    <img src="img/brembo.jpg" width="120" height="60">
                    <img src="img/ohlin.png" width="120" height="60">
                    <img src="img/akrapovic.png" width="120" height="60">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">MotoServ 2023</a>, All Right Reserved.

                        <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                        Designed By <a class="border-bottom" href="#">Team5</a>
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <div class="footer-menu">
                            <a href="index.php?controller=home&action=main">Home</a>
                            <a href="index.php?controller=home&action=faq">FAQs</a>                            
                        </div>
                    </div>
                </div>
            </div>
